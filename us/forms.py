...
class crearUsForm(forms.ModelForm):
    class Meta:
        model = Us
        fields = '__all__'
        exclude=['project','estado', 'activo', 'user', 'storypoints','estimacionscrum',
                 'estimaciondesarrollador']
        labels = {
            'name': 'Nombre',
...
class editUsForm(forms.ModelForm):
    class Meta:
        model = Us
        fields = '__all__'
        exclude = ['project', 'activo', 'user', 'storypoints', 'estado',
                   'estimaciondesarrollador','estimacionscrum']
        widgets = {
            'name': forms.TextInput(
                attrs={
                    'placeholder': 'Ingrese el nombre del User Story',
